            ...
            <div className="relative z-20 bg-white h-full">
                ...
                <div className="border-[2px] p-6 border-[#B7B7B7]">
                    ...
                    <label className="flex justify-center items-center gap-2 w-full rounded-none border-2 border-[#B7B7B7] px-3 py-2 mt-6 mb-12">
                        ...
                        <input
                            type="text"
                            className="grow outline-none text-[#1E1E1E] placeholder:text-[#B7B7B7]"
                            placeholder="Search"
                        />
                    </label>
                    ...
                    <div className="flex justify-between gap-2 border-b border-[#B7B7B7] mb-12">
                        <button
                            ...
                            className={`jost-font-uppercase cursor-pointer text-[16px] font-[400] pb-3 transition-all ${activeTab === "collections"
                        ...
                        <button
                            ...
                            className={`jost-font-uppercase cursor-pointer text-[16px] font-[400] pb-3 transition-all ${activeTab === "categories"
                                ? "border-b-2 border-[#1E1E1E] text-[#1E1E1E] w-38"
                                : "border-b border-transparent text-[#B7B7B7]"}`}
                        >
                            Categories
                        ...
                        <div className="flex flex-col gap-3 text-[#1E1E1E]">
                            {buttons.map(btn => (
                                <button
                                    ...
                                    className="jost-font-uppercase cursor-pointer flex items-center gap-2"
                                >
