  ...
  return (
    <div className="border-t-1 border-[#7D7D7D] px-4">
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6">
        ...
        >
          🎉 Boishakhi Collection Coming Soon
        </h1>
        ...
        >
          We’re preparing something special for you. Stay tuned for our exclusive Boishakhi collection launch!
        </p>
      </div>
...
export default BoishakhiCollection;
