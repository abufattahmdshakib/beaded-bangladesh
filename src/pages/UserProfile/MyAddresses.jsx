    ...
    <div className="p-6 space-y-6">
      {showAddForm ? (
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div
            className="flex-1 flex flex-col p-4 bg-gray-200 justify-center items-center hover:bg-gray-300 cursor-pointer"
          ...
          >
            <div className="flex-1 flex flex-col justify-center items-center gap-2">
              ...
              <span className="text-[#1E1E1E] font-[400] jost-font-uppercase text-lg">
                Add New Address
              </span>
            </div>
          </div>
