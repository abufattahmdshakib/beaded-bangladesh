  ...
  return (
    <div  className="border-t-1 border-[#7D7D7D] px-4">
      <div className="max-w-10/12 mx-auto my-20">
        ...
        {/* User Name */}
        <h2 className="text-center jost-font-uppercase text-[40px] font-[500] text-[#1E1E1E] mb-16">
          {user?.displayName || "User"}
        </h2>

        {/* Tabs */}
        <div className="flex justify-around mb-4 flex-wrap gap-2 border-b-2 border-gray-300">
          <button
